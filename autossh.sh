...
autossh -M 56400 -f -N -o "PubkeyAuthentication=yes" -o "PasswordAuthentication=no" -o "ServerAliveInterval 5" -o "ServerAliveCountMax 2" -o "ExitOnForwardFailure yes" -i /home/chip/.ssh/id_rsa -R 43200:localhost:22 -L 9092:localhost:9092 user@host &
